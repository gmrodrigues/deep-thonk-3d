...
#include <memory>
#include "../../../../src/ui/model/RuleModel.h"
...
Q_CONSTINIT static const qt_meta_stringdata_RuleModel_t qt_meta_stringdata_RuleModel = {
    {
        ...
        QT_MOC_LITERAL(10, 13),  // "onRuleMatched"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 6)   // "ruleId"
    },
    "RuleModel",
    "onRuleMatched",
    "",
...
void RuleModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onRuleMatched((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
